      ...
      <div className="max-w-[1280px] mx-auto px-6 sm:px-8 lg:px-12 py-8 lg:py-12">
                ...
                <div className="absolute top-full mt-2 bg-white border border-[#E5E7EB] rounded-lg shadow-lg py-1 z-10 min-w-[180px]">
                  {(Object.keys(periodLabels) as Array<keyof typeof periodLabels>).map((key) => (
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 hover:bg-[#F3F4F6] transition-colors ${timePeriod === key ? 'bg-[#F3F4F6] text-[#2C3E50] font-semibold' : 'text-[#5A6C7D]'
                        }`}
                    >
                      {periodLabels[key]}
                    </button>
        ...
        <div className="flex gap-3 mb-8">
          <button
            ...
            className={`px-6 py-2.5 rounded-full text-sm lg:text-base font-medium transition-all ${propertyType === "flat"
          ...
          <button
            ...
            className={`px-6 py-2.5 rounded-full text-sm lg:text-base font-medium transition-all ${propertyType === "builder"
                ? "bg-[#E0E7FF] text-[#2C3E50] shadow-sm"
                : "bg-white text-[#6B7280] border border-[#E5E7EB] hover:bg-[#F9FAFB]"
              }`}
          >
